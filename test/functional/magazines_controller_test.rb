...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { date: @magazine.date, name: @magazine.name, number: @magazine.number, status: @magazine.status, volume: @magazine.volume }
    end
  ...
  test "should update magazine" do
    put :update, id: @magazine, magazine: { date: @magazine.date, name: @magazine.name, number: @magazine.number, status: @magazine.status, volume: @magazine.volume }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
